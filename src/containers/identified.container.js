...
class Identified extends React.Component {
    constructor(props) {
        super(props);
              ...
              (
                <ul id='list' key={i}>
                  <li>
                    ...
                    &nbsp;
                    <Link to={"/writereview/" + book.id} className="btn btn-success">Write Review</Link>
                  </li>
                </ul>
              )
            )}
        ...
        <div>
          <div>
            ...
            <div id='body'>
              ...
              <h6>You are logged in, so you can write your own reviews!</h6>
              <br/>
            ...
            <br/>
            <div id='body'>
              <label>Can't find what you're looking for?</label>&nbsp;
              <Link to="/search" className="btn btn-warning">Add a New Book</Link>
              {renderedBooks}
            </div>
          </div>
        </div>
...
let mapDispatchToProps = function (dispatch, props) {
  return {
    ...
    getUserStatus: (name) => dispatch(getUserStatus(name)),
  }
}
